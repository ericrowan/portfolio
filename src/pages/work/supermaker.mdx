...
[See live](https://supermaker.com/) &#8594;

</Container>

<Container full grid>

<Box alignSelf='center' mx='auto' color={colors.supermaker.white} maxWidth={sizes.small} px={'8vmax'}>

### Early mockups

We scoured magazines and other editorials for inspiration and ideas. Mixing and matching elements, the first concepts for look-and-feel were presented.
