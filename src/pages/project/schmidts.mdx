...
Interactive design and front-end development, working alongside Schmidt&rsquo;s internal digital strategy team. Starting in a Portland, Oregon kitchen, Schmidt&rsquo;s natural soaps and deodorants can now be purchased in stores all over the world. I led the design on several projects while working with Schmidt&rsquo;s, including on both new and existing features.

[Live website](https://schmidts.com/)

</Container>


<Box maxWidth={sizes.xsmall} mx='auto'>
...
<Container grid gridCols={'repeat(4, 1fr)'} width={sizes.large}>
...
<Link to='/project/scag'>


<Heading fontSize={[6, 7, 8]}>Scag Mower Parts</Heading>
