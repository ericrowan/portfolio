...
<Container full grid backgroundColor={colors.supermaker.red}>

<Box alignSelf='center' mx={[0, 'auto']} maxWidth={['100%', sizes.xsmall]} mb={[2, 0]}>
...
<Container full grid gridCols={'repeat(3, 1fr)'}>
...
<Container grid full gridCols={'repeat(3, 1fr)'}>
